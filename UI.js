...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" bg="#ff4fb3ff" title="强国助手共存版2.2.1"/>
            ...
            <viewpager id="viewpager">
                ...
                <img src={"https://api.wuque.cc/random/images" } scaleType="centerCrop" alpha="1" />
                    <vertical>
                        ...
                        <button h="60" layout_gravity="center" id="log" textSize="18sp" text="查看日志" alpha="0.5"/>
                        <button h="60" layout_gravity="center" id="update" textSize="18sp" />
                        <button id="start" text="开 始 学 习" textSize="25sp" color="#ffffff" bg="#FF4FB3FF" foreground="?selectableItemBackground"   alpha="0.55"/>
                    </vertical>
                </frame>
                <ScrollView>
                    <frame>
                    <img src={"https://api.wuque.cc/random/images" } scaleType="centerCrop" alpha="0.8" />
