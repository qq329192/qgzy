...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" bg="#ff4fb3ff" title="强国助手共存版1.0"/>
                    ...
                    <frame>
                        <vertical id="ttxs_pro" gravity="center">
                            ...
                            <horizontal  gravity="center_vertical" padding="5 5" >
                                <View bg="#00BFFF" h="*" w="10"  ></View>
                                <vertical padding="10 8" h="auto" w="0" layout_weight="1">
                                    <text w="auto" textColor="#222222" textSize="15sp" text="多账号(选填，最多测试个)" />
...
ui.start.click(function () {
    ...
    threads.start(function () {
        let url = [
              'https://cdn.jsdelivr.net/gh/qq329192/qgzy/'+ui.script_chosen.getSelectedItemPosition()+'.js',
